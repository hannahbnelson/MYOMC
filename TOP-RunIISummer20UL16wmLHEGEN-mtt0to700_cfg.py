...
# with command line options: Configuration/GenProduction/python/pythia-fragment-mtt0to700.py --era Run2_2016 --customise Configuration/DataProcessing/Utils.addMonitoring --beamspot Realistic25ns13TeV2016Collision --step LHE,GEN --geometry DB:Extended --conditions 106X_mcRun2_asymptotic_v13 --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(286) --datatier GEN,LHE --eventcontent RAWSIM,LHE --python_filename TOP-RunIISummer20UL16wmLHEGEN-mtt0to700_cfg.py --fileout file:GEN-00000.root --number 10 --no_exec --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/pythia-fragment-mtt0to700.py nevts:10'),
...
process.LHE_Mtt_0to700_filter = cms.EDFilter("LHEmttFilter",
    MaxInvMass = cms.double(700),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/afs/cern.ch/user/h/hnelson/TT01j2lBSMRef_v2_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.LHE_Mtt_0to700_filter)
...
process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(286)
